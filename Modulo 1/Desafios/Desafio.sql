...
/*Crear una tabla con el nombre “AGENDA”
dentro de la base de datos.

AGENDA
ID Contacto integer PK
Nombre varchar(20) NOT NULL
Apellido varchar(15) NOT NULL
Domicilio varchar(50)
Teléfono integer NOT NULL*/

CREATE TABLE agenda (IDcontacto INT, PRIMARY KEY (IDcontacto), nombre varchar(20) NOT NULL,
apellido varchar(15) NOT NULL, domicilio varchar(50), telefono int NOT NULL);
...
INSERT INTO agenda (IDcontacto, nombre, apellido, domicilio, telefono) values ('1', 'Juan', 'Perez', 'Sarmiento 1928', 98876652),
('2', 'Claudio', 'Sonda', 'Cabildo 543', 98233452),
('3', 'Nora', 'Dominguez', 'Paredes 1987 10mo 13', 14229866),
('4', 'Julia', 'Gugliemi', 'Jacarandá 7655', 54336777);
...
use libreria;
CREATE TABLE autores(autor_id varchar(11), apellido varchar(40), nombre varchar(20), telefono varchar(12),
direccion varchar(40), ciudad varchar(20), provincia char(2), c_postal char(5), estado tinyint(1));
...
CREATE TABLE ventas(local_id char(4), factura_nro varchar(20), fecha datetime, cantidad smallint,
forma_pago varchar(12), libro_id varchar(6));
...
CREATE TABLE locales(local_id char(4), nombre varchar(40), direccion varchar(40), ciudad varchar(20),
provincia char(2), c_postal char(5));
...
CREATE TABLE editoriales(editorial_id char(4), nombre varchar(40), ciudad varchar(20),
...
CREATE TABLE libros(libro_id varchar(6), titulo varchar(80), categoria char(12),
editorial_id char(4), precio double, comentarios varchar(200), fecha_publicacion datetime);

/*libroautor
● autor_id VARCHAR(11)
● libro_id VARCHAR(6)*/

CREATE TABLE libroautor(libro_id varchar(6), autor_id varchar(11));
...
CREATE TABLE empleados(empleado_id varchar(9), nombre varchar(20), apellido varchar(30),
...
CREATE TABLE puestos(puesto_id smallint, descripcion varchar(50));
...
('6344clientes_neptuno','722','1994-09-13 00:00:00',3,'Efectivo','PS2091'),
...
ALTER TABLE ventas ADD PRIMARY KEY (local_id);
...
ALTER TABLE libroautor ADD PRIMARY KEY (empleado_id);
...
INSERT INTO autores VALUES 
('654-52-7526','Cortazar','Julio','23451123','','Buenos Aires','CF','2433',1),
('153-25-5311','Garcia Marques','Jose','93844455','','Bogota','BO','5443',1),
('512-22-4552','Perecito','Raul','1252333','','Santiago','SA','2344',1);

INSERT INTO editoriales VALUES 
('2433','Naranja','Buenos Aires','CF','Argentina'),
('4223','Esqueleto','Buenos Aires','CF','Argentina'),
('6555','La verdadera','Buenos Aires','CF','Argentina');

INSERT INTO empleados VALUES 
('PAS13443M','Julio','Alcorta',22,'2533','1988-03-25 00:00:00'),
('JAH24345M','Federico','Esdra',12,'5133','1991-02-04 00:00:00'),
('ASI20334F','Erica','Domingo',7,'1299','1995-10-05 00:00:00');
...
INSERT INTO libros VALUES 
('DF8592','Mi libro SQL','Manual','2533',3000.50,'','2010-08-22 00:00:00'),
('H9588','El Imperio Ataca','Cuento','9772',1500.47,NULL,'1984-02-12 00:00:00'),
('NO8234','La venganza','Cuentos','3111',800.44,'','1922-12-07 00:00:00');

INSERT INTO locales VALUES 
('5233','Gestalt','Callao 293','Buenos Aires','BA','213144'),
('9855','Librería Josesito','Diagonal 351 1999','La Plata','BA','25133'),
('4123','Libreria fuega','Calle 144 1988','Gran Buenos Aires','BA','24111');

INSERT INTO puestos VALUES 
(15,'Empleado de limpieza'),
(16,'Barista'),
(17,'Empleado de logistica');

INSERT INTO ventas VALUES 
('2513','1233','2001-12-25 00:00:00',4,'Crédito','JH8922'),
('1251','2555','1988-09-02 00:00:00',2,'Efectivo','MK9822'),
('6343','6123','2005-08-02 00:00:00',12,'Transferencia','LO9111');